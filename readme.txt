...
- The Figures 4-8 for each country are saved in the folders with the names for each country. They
were produced in the Rcode and then manually copied and/or saved into the folder. In the file DR_codes.R
you can find the codes for the figures named after the order in which they appear: "Fig.1., Fig.2,...Fig.,4".

- Figures 1-3 are in the main folder, as they are not country-specific. Fig 1 is a combination of manually
adapted figure and R written. For those that were manually adapted they are also contained in a
-ppt file so you can see the part that was adapted. The rest are explicitly mentioned in the Rcode file.
